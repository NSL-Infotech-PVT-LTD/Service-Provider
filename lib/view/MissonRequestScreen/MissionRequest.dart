...
//   int futureTimeInMilliSeconds = 0;
//
//   void onEnd() {
//     print('onEnd');
//   }
...
//   void initState() {
//     // registerUser();
//     if (futureTimeInMilliSeconds != 0) {
//       getString("future_time")
//           .then((value) => futureTimeInMilliSeconds = int.parse(value))
//           .whenComplete(() {
//         setState(() {
//           print("HERE IS THE TIME $futureTimeInMilliSeconds");
//         });
//       });
//     }
//
...
//           //         : 0));
//
//           var durationTimeINeedInMilliSeconds =
//               futureTimeInMilliSeconds - DateTime.now().millisecondsSinceEpoch;
//
//           //
//           // print(
//           //     "ALFENO ${((getJobByIdModel.data.estimatedHours.split(":")
//           //         .elementAt(0) != "0" ? int.parse(
//           //         getJobByIdModel.data.estimatedHours.split(":").elementAt(0)) *
//           //         3600 : 0 * 3600) +
//           //         (getJobByIdModel.data.estimatedHours.split(":").elementAt(
//           //             1) != "0" ? int.parse(
//           //             getJobByIdModel.data.estimatedHours.split(":").elementAt(
//           //                 1)) * 60 : 0 * 60) +
//           //         (getJobByIdModel.data.estimatedHours.split(":").elementAt(
...
//           //             getJobByIdModel.data.estimatedHours.split(":").elementAt(
//           //                 2)) : 0))}");
//           print("ALFENO $durationTimeINeedInMilliSeconds");
//
//           endTime = DateTime.now().millisecondsSinceEpoch +
//               1000 * ((durationTimeINeedInMilliSeconds.toUnsigned(1) / 1000).round());
//
...
//                           );
//                         } else {
//                           futureTimeInMilliSeconds = DateTime.now()
//                                   .millisecondsSinceEpoch +
//                               (((getJobByIdModel.data.estimatedHours.split(":").elementAt(0) != "0"
//                                           ? int.parse(getJobByIdModel.data.estimatedHours.split(":").elementAt(0)) *
//                                               3600
//                                           : 0 * 3600) +
...
//                                           : 0)) *
//                                   1000);
//                           print("TIME IN EACH $futureTimeInMilliSeconds");
//                           setString("future_time", "$futureTimeInMilliSeconds");
//
//                           currentCaseStatus = 3;
//                           _panelController.close();
//                         }
...
class _MissionRequestState extends State<MissionRequest> {
  ...
  bool isAcceptButtonPressed = false;
  bool isDeclineButtonPressed = false;
  int futureTimeInMilliSecondsEachPoch;
  String viewValue = "pending";
  final GlobalKey qrKey = GlobalKey(debugLabel: 'QR');
  String cc;
  Barcode result;
    ...
    getString(sharedPref.userToken).then((value) {
      ...
      ApiCaller()
        ...
        setState(() {
          ...
          locationController.text = getJobByIdModel.data.location;
          dateController.text =
          "${getJobByIdModel.data.startDate.day}/${getJobByIdModel.data
              .startDate.month}/${getJobByIdModel.data.startDate.year}";
          timeController.text = getJobByIdModel.data.startTime;
          moneyController.text = getJobByIdModel.data.budget.toString();
          descriptionController.text = getJobByIdModel.data.description;
          viewValue = getJobByIdModel.data.jobStatus;
          if(getJobByIdModel.data.jobStatus=="processing") {

            getString("futureTime").then((value) {
              // auth = value;
              futureTimeInMilliSecondsEachPoch = int.parse(value);
              print("Future is here ========> $value");
            }).whenComplete(() {
              endTime = DateTime
                  .now()
                  .millisecondsSinceEpoch
                  + (futureTimeInMilliSecondsEachPoch - DateTime
                      .now()
                      .millisecondsSinceEpoch)
              ;
            });
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        // "28/04/2021, 2:00 PM",
                        "${getJobByIdModel.data.startDate.toString()
                            .split(" ")
                            .elementAt(0)}, ${getJobByIdModel.data.startTime
                            .toString().split(":").elementAt(
                            0)}: ${getJobByIdModel.data.startTime.toString()
                            .split(":")
                            .elementAt(1)}",
                        style: TextStyle(
                            color: CColors.missonNormalWhiteColor,
                    ...
                    onPressed: () {
                      ...
                      ApiCaller()
                        ...
                        if (changeJobStatusModel.code == 422) {
                          ...
                          setString("futureTime",
                              "${DateTime
                                  .now()
                                  .millisecondsSinceEpoch + (1000 *
                                  ((getJobByIdModel.data.estimatedHours.split(
                                      ":").elementAt(0) != "0" ? int.parse(
                                      getJobByIdModel.data.estimatedHours.split(
                                          ":").elementAt(0)) * 3600 : 0 *
                                      3600) +
